...
async function whatsAsena () {
    ...
    conn.on ('credentials-updated', async () => {
        console.log(
            chalk.blueBright.italic('✅ Login Information යාවත්කාලීන කර අවසන් ස්තූතීයි!')
        );
...
${chalk.blue.italic('ℹ️ වට්සැප් ගිනුම වෙත සම්න්බන්ධ වෙමින් පවතී....කරුණාකර රැදී සිටින්න.')}`);
    });
    

    conn.on('open', async () => {
        console.log(
            chalk.green.bold('✅ පූරණය සාර්ථකයි .ස්තූතියි!')
        );
        ...
        console.log(
            chalk.blueBright.italic('⬇️ ප්ලගීන ස්ථාපනය වෙමින් පවතී...')
        );
        ...
        console.log(
            chalk.green.bold('✅ දැන් ඔබගේ බාහිර ප්ලගීන ස්තාපනය කර අවසන්..!')
        );
        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '994775035797@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*DaTa Lover Working as Public! 🐺*\n\n_Please do not try plugins here. This is your LOG number._\n_You can try commands to any chat :)_\n\n*Your bot working as public. To change it, make the “WORK_TYPE” switch “private” in config vars.*\n\n*Thanks for using DaTa Lover 💌*', MessageType.text);
